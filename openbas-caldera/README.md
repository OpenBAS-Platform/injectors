...
The Caldera injector is a maven dependency allowing to perform Caldera abilities action through OpenBAS.
...
- OpenBAS Platform version 3.6.0 or higher with caldera injector dependency
