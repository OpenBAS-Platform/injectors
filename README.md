...
The following repository is used to store the OpenBAS injectors for the platform integration with other tools and applications.

## OpenBAS usage

Injectors must be started along with the platform api, using "lib" directory
- openbas-api.jar
- lib/openbas-injector-01.jar 
- lib/openbas-injector-02.jar
- lib/openbas-injector-03.jar
